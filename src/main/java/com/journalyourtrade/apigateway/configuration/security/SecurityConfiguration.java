package com.journalyourtrade.apigateway.configuration.security;

import com.journalyourtrade.apigateway.configuration.filter.JwtRequestFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/eureka/**").permitAll()
                .antMatchers("/api/v1/gateway/authenticate").permitAll()
                .antMatchers("/user-service/api/v1/user/create").permitAll()
